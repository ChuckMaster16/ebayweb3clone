  ...
  const createBidorOffer = async () => {
    ...
    try {
      ...
      if (listing?.type === ListingType.Direct) {
        ...
        console.log('buyout amount was not met, please make an offer to buy this NFT')
        ...
        await makeOffer({
          ...
          onError(error, variables, context) {
            alert('NFT offer could not be completed please try again or change the offer amount');
